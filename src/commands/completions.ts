...
function fishScript(): string {
  const out: string[] = [];
  out.push('# fish completions for coord — generated by `st completions fish`.');
...
function bashScript(): string {
  ...
  lines.push('# bash completion for coord — generated by `st completions bash`.');
...
function zshScript(): string {
  ...
  lines.push('# zsh completion for coord — generated by `st completions zsh`.');
